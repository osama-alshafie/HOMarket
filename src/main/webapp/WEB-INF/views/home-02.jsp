    ...
    <div class="wrap_menu">
        <nav class="menu">
            <ul class="main_menu">
                ...
                <li>
                    <a href="contact.jsp">Regester1</a>
                </li>
                <li>
                    <a href="<spring:url value="/" var="kmhome16"></spring:url>">registeration2</a>
                </li>
            </ul>
        </nav>
    </div>
...
<section class="slide1">
    <div class="wrap-slick1">
        <div class="slick1">
            <div class="item-slick1 item1-slick1" style="background-image: url(<spring:url
            ...
            <div class="item-slick1 item2-slick1" style="background-image: url(<spring:url
            ...
            <div class="item-slick1 item3-slick1" style="background-image: url(<spring:url
                    value="/resources/images/master-slide-02.jpg"></spring:url>);">
                <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                    <h2 class="caption1-slide1 xl-text2 t-center bo14 p-b-6 animated visible-false m-b-22"
...
<section class="parallax0 parallax100"
         style="background-image: url(<spring:url value="/resources/images/bg-video-01.jpg"></spring:url>);">
